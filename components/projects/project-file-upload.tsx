...
import { uploadProjectAttachment } from "@/server/actions/project-attachments";
...
export function ProjectFileUpload({ projectId, onSuccess }: ProjectFileUploadProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await uploadProjectAttachment(formData);
